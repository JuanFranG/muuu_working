...
interface ZafiroRegisterCompanyScreenErrorCompanyNameProps {
  onBack: () => void;
  onRegisterSuccess: () => void;
}

export function ZafiroRegisterCompanyScreenErrorCompanyName({ onBack, onRegisterSuccess }: ZafiroRegisterCompanyScreenErrorCompanyNameProps) {
  ...
  const companyNameError = 'Ingresa nombre válido';
