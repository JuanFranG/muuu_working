...
export function Configuraciones({ onBack, userRole = 'student', onLogout }: ConfiguracionesProps) {
  ...
  const headerBg = isStudent ? '#9B7EC7' : '#FFD700';
  const headerText = isStudent ? '#FFFFFF' : '#1A1A1A';
  const bgGradient = isStudent 
    ? 'linear-gradient(180deg, #F3EBFF 0%, #FFFFFF 100%)'
    : 'linear-gradient(180deg, #FFFDE7 0%, #FFFFFF 100%)';
  const borderColor = isStudent ? '#E6D5F0' : '#FFF9C4';
              ...
              <div className="flex items-center gap-3">
                <div
                  style={{
                    ...
                    height: '40px',
                    borderRadius: '10px',
                    backgroundColor: isStudent ? '#F3EBFF' : '#FFFDE7',
                    display: 'flex',
                    alignItems: 'center',
