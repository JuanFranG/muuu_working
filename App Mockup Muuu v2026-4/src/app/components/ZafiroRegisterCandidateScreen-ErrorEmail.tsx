...
interface ZafiroRegisterCandidateScreenErrorEmailProps {
  onBack: () => void;
  onRegisterSuccess: () => void;
}

export function ZafiroRegisterCandidateScreenErrorEmail({ onBack, onRegisterSuccess }: ZafiroRegisterCandidateScreenErrorEmailProps) {
  ...
  const emailError = 'Correo electrónico inválido';
