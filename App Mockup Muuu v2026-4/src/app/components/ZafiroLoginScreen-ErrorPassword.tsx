...
interface ZafiroLoginScreenErrorPasswordProps {
  onBack: () => void;
  onLogin: () => void;
  onRegister: () => void;
...
export function ZafiroLoginScreenErrorPassword({ onBack, onLogin, onRegister, userType }: ZafiroLoginScreenErrorPasswordProps) {
