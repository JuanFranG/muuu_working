...
interface ZafiroRegisterCompanyScreenErrorNITProps {
  onBack: () => void;
  onRegisterSuccess: () => void;
}

export function ZafiroRegisterCompanyScreenErrorNIT({ onBack, onRegisterSuccess }: ZafiroRegisterCompanyScreenErrorNITProps) {
  const [formData, setFormData] = useState({
    companyName: 'TechCorp S.A.S.',
